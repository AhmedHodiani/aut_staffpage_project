...
@Component({
  selector: 'app-scholarship-ar',
  templateUrl: './scholarship-ar.component.html',
  styleUrls: ['./scholarship-ar.component.scss']
})
export class ScholarshipArComponent implements OnInit {
  form: FormGroup;
