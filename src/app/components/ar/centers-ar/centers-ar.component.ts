...
@Component({
  selector: 'app-centers-ar',
  templateUrl: './centers-ar.component.html',
  styleUrls: ['./centers-ar.component.scss']
})
export class CentersArComponent implements OnInit {

  center: any;
  journalUrl: any;
  flipedBook: any;
  constructor(private _route: ActivatedRoute, private _centersService: CentersService, private _apiService: ApiService) { }
