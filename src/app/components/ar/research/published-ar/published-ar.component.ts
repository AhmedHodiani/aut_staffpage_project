...
import { ApexChart, ChartComponent, ApexLegend } from 'ng-apexcharts';
...
@Component({
  selector: 'app-published-ar',
  templateUrl: './published-ar.component.html',
  styleUrls: ['./published-ar.component.scss'],
})
export class PublishedArComponent implements OnInit {
  // researches: any;
  colleges: any;
  ...
  getResearches() {
    this._apiService.getResearches().subscribe(
      (data) => {
        var colleges = data;
  ...
  getYears(data) {
    ...
    data.forEach((ele) => {
      var ress = this.isChecked
        ? ele.researches
        : ele.researches.filter((i) => i.is_in_uni == true);
  ...
  getSeries(data, years) {
    ...
    data.forEach((college) => {
      ...
      years.forEach((year) => {
        ...
        var ress = this.isChecked
          ? college.researches
          : college.researches.filter((i) => i.is_in_uni == true);
        ress.forEach((research) => {
